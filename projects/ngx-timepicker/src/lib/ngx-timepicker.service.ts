...
export type TimepickerDisableEnableDate =
  | string
  | Moment
  | Date
  | { from: Date | string | Moment; to: Date | string | Moment };

export class NoneObject {
  label: string;
  value: string;
  className: string;
...
export class TimepickerConfig {
   ...
   */
  disableTimeRanges?: TimepickerDisableEnableDate[];
  /**
   * Default: false
   ...
   */
  roundingFunction?: (seconds: number, settings: TimepickerConfig) => number;
  /**
   * Default: null
